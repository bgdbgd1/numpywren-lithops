...
def run_experiment(problem_size, shard_size, pipeline, num_priorities, lru, eager, truncate, max_cores, start_cores,
    ...
    try:
        while program.program_status() == lp.PS.RUNNING:
            ...
            busy_workers = get("{0}_busy".format(program.hash))
            sparse_writes = parse_int(get("{0}_write_sparse".format(program.hash))) / 1e9
...
if __name__ == "__main__":
    ...
    parser.add_argument('--start_cores', type=int, default=2)
